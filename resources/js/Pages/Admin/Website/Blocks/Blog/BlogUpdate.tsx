...
const BlogUpdate: React.FC<{category: string, block: Block}> = ({category, block}) => {
    ...
    const methods = useForm({
        ...
        defaultValues: {
            ...
            date: new Date(block?.startDate || new Date()),
        }
    });
    ...
    const onSubmit =  () => {
        ...
        formData.append('startDate', new Date(methods.getValues('date')).toDateString());
