...
const ContactLinkUpdate: React.FC<{category: string, menus: Menu [], menu: Menu}> = (
    {category, menus, menu}
) => {
    ...
    const [linkType, setLinkType] = React.useState<ContactMenuEnum>(menu.type as ContactMenuEnum);
            ...
            <FormProvider {...methods}>
                ...
                >
                    ...
                    <ValidatedSelect
                        ...
                        items={menuService.getAllTranslations(selectedMenus)}
                    />
...
export default ContactLinkUpdate;
